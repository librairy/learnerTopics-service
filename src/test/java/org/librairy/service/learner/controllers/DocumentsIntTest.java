 ...
 */
public class DocumentsIntTest {

    private static final Logger LOG = LoggerFactory.getLogger(DocumentsIntTest.class);
...
//        jacksonObjectMapper.enable(SerializationFeature.INDENT_OUTPUT);
    ...
    @Test
    public void train() throws UnirestException {
        ...
        parameters.setParameters(ImmutableMap.of("topics","2"));

        HttpResponse<JsonNode> response = Unirest
                .post("http://localhost:8080/dimensions")
                .basicAuth("learner", "oeg2018")
                .body(parameters).asJson();
